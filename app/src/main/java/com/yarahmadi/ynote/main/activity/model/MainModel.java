package com.yarahmadi.ynote.main.activity.model;


import com.yarahmadi.ynote.data.DAO;
 ...
 */
public class MainModel implements MainInterface.ProvidedModelOps {

    // Presenter reference
    private MainInterface.RequiredPresenterOps mPresenter;
    private DAO mDAO;
    // Recycler data
     ...
     */
    public MainModel(MainInterface.RequiredPresenterOps presenter) {
     ...
     */
    public MainModel(MainInterface.RequiredPresenterOps presenter, DAO dao) {
        this.mPresenter = presenter;
        mDAO = dao;
    }
